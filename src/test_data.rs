...
pub fn generate_tetrahedron() -> PolyMesh {
    let mut mesh = PolyMesh::new();
...
pub fn generate_pyramid() -> PolyMesh {
    let mut mesh = PolyMesh::new();
...
pub fn generate_icosahedron() -> PolyMesh {
    let mut mesh = PolyMesh::new();
...
pub fn generate_icosphere(subdivisions: u32) -> PolyMesh {
...
pub fn generate_grid(rows: usize, cols: usize) -> PolyMesh {
    let mut mesh = PolyMesh::new();
...
pub fn generate_sphere(radius: f32, segments: usize, rings: usize) -> PolyMesh {
    let mut mesh = PolyMesh::new();
...
/// Generate a torus
pub fn generate_torus(major_radius: f32, minor_radius: f32, major_segments: usize, minor_segments: usize) -> PolyMesh {
    let mut mesh = PolyMesh::new();
...
pub fn generate_noisy_sphere(radius: f32, noise: f32, segments: usize, rings: usize) -> PolyMesh {
    use rand::Rng;
    let mut mesh = PolyMesh::new();
...
pub fn save_mesh<P: AsRef<Path>>(mesh: &PolyMesh, path: P) -> crate::io::IoResult<()> {
    crate::io::write_mesh(mesh, path)
}

/// Load generated mesh from file
pub fn load_mesh<P: AsRef<Path>>(path: P) -> crate::io::IoResult<PolyMesh> {
